 ...
 */
        if (clickedEvent === "RED") {
            ...
            document.getElementById("square").style.backgroundColor = "darkorange";
            document.getElementById("circle").style.backgroundColor = "darkorange";
            document.getElementById("ellipse").style.backgroundColor = "darkorange";
            document.getElementById("rectangle").style.backgroundColor = "darkorange";
        }
        else {
